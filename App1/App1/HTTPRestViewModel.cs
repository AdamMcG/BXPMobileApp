...
namespace App1
{
    class HTTPRestViewModel : INotifyPropertyChanged
    {
        ...
        public async Task RESTcalls_POST_BXPAPI()
        {
            try{
                //Set up client
                ...
                new[] { 
                new KeyValuePair<string, string>("system", "formlogging"),
                ...
                new KeyValuePair<string, string>("strCDA_751_field_1_1", "Fernando"),
                new KeyValuePair<string, string>("strCDA_751_field_2_1","L"),
                new KeyValuePair<string, string>("strCDA_751_field_3_1", "Munez"),

                new KeyValuePair<string, string>("homephone", "22222"),
                new KeyValuePair<string, string>("workphone", "12322"),
                new KeyValuePair<string, string>("mobile","0863222"),


                new KeyValuePair<string, string>("address1", "appartment 5"),
                new KeyValuePair<string, string>("address2","Fake Road"),
                new KeyValuePair<string, string>("address3", "Tallaght"),
                new KeyValuePair<string, string>("postcode", "Dublin24"),
                new KeyValuePair<string, string>("country","Ireland")
                });
#endregion
       ...
       public async Task RESTcalls_TESTING_BXPAPI()
       {
           HttpClient myClient = new HttpClient();
           ...
           Uri apiUri = new Uri("https://ww3.allnone.ie/client/client_demo/cti/userCTI_GenericEntry.asp");
